              ...
              <div class="filter-active tour-booking-active">
                <div class="filter-item tab-content1">
                  <div class="info-image">
                    <img src="assets/img/tours/tour-information.jpg" alt="tours-img">
                  </div>
                  ...
                  <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                      <p class="tour-price"><strong>Rs. 1500</strong> / Per Hour</p>
                    </div>
                  </div>
                  ...
                  <table class="infolist">
                    ...
                    <tr>
                      <td class="info-heading">Facilities</td>
                      <td>
                    ...
                    <tr>
                      <td class="info-heading">Minimum Time</td>
                      <td class="info">2 Hours</td>
                    </tr>
                  </table>
                </div>
                  ...
                  <div class="gx-gy gallery-mesonary">
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-1.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-1.jpg" class="popup-image"><i
                    ...
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-2.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-2.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-3.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-3.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-4.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-4.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-5.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-5.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-6.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-6.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-7.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-7.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-8.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-8.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="grid-item">
                      <div class="gallery-img5">
                        <img src="assets/img/gallery/gallery-3-9.jpg" alt="images">
                        <div class="gallery-content">
                          <a href="assets/img/gallery/gallery-3-9.jpg" class="gallery-img"><i
                              class="fas fa-plus"></i></a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="rating-wrap">
                    <div class="rating-author">
                      <div class="author-image">
                        <img src="assets/img/author/rating-author.jpg" alt="Rating Author">
                      </div>
                ...
                <div class="widget">
                  ...
                  <form class="booking-form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" placeholder="Total Persons?" />

                    </div>
                    <div class="price_slider_wrapper">
                      <h3 class="widget_title">Filter By Category</h3>
                      <div class="form-group">
                        <i class="fas fa-calendar-alt"></i>
                        <select class="form-select" name="name">
                          <option value="" selected="selected" disabled="disabled" hidden="">Select Category</option>
                          <option value="">Category 1</option>
                          <option value="">Category 2</option>
                          <option value="">Category 3</option>
                          <option value="">Categroy 4</option>
                        </select>
                      </div>

                    </div>
                    <div class="price_slider_wrapper">
                      <h3 class="widget_title">Filter By Location</h3>
                      <div class="form-group">
                        <i class="fas fa-calendar-alt"></i>
                        <select class="form-select" name="name">
                          <option value="" selected="selected" disabled="disabled" hidden="">Select Category</option>
