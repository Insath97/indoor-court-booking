...
<head>
  ...
  <title>
    Travolo - Travel Agency & Tour Booking HTML Template - About Us
  </title>
...
<body>
        ...
        <div class="container position-relative z-index-common">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col !align-items-center !align-items-lg-none  text-end text-xl-center">
              <nav class="main-menu  menu-style1 d-phpone d-lg-block">
                <ul>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="image-box1">
            ...
            <img class="img2" src="assets/img/about/img-2-2.jpg" alt="image2">
            <div class="media-box1">
              <span class="media-info">5 Years</span>
        ...
        <div class="col-lg-5">
          <div class="about-content">
            <div class="title-area">
              <span class="sec-subtitle">We are Court</span>
              <h2 class="sec-title h1">We Are The Best For Your COurt </h2>
            ...
            <a href="about.php" class="vs-btn style4">View More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  ==============================-->
  <section class="space-top space-extra-bottom offer-style1" data-bg-src="assets/img/bg/offer-bg.jpg">
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-xl-5 col-lg-6">
          <div class="title-area white-title">
            <span class="sec-subtitle">Come & Play</span>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6">
          <div class="title-area white-title">
            ...
            <h2 class="sec-title h1">1,000 Happy Clients Around The Srilanka</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row vs-carousel" data-slide-show="3" data-arrows="false" data-lg-slide-show="2" data-md-slide-show="2"
        ...
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            ...
            <div class="blog-content">
              <h2 class="blog-title"><a href="blog-details.php">We are Giving Amazing Tour For VIP</a></h2>
        ...
        <div class="col-xl-4">
          <div class="vs-blog blog-style3">
            ...
            <div class="blog-content">
              <h2 class="blog-title"><a href="blog-details.php">Uncharted territories exploring the unknown</a></h2>
              <p class="blog-text">Lorem ipsum dolor sit amet, adipiscfvdg fgjnving consectetur adipiscing elit. dolor
                sit amet.</p>
              <div class="blog-bottom">
  ...
  <div class="sidemenu-wrapper offcanvas-wrapper d-none d-lg-block">
    <div class="sidemenu-content">
      ...
      <div class="widget">
        <div class="vs-widget-about">
          <div class="footer-logo">
            <a href="index.php"><img src="assets/img/logo.svg" alt="Travolo"></a>
          </div>
          <p class="footer-text">
      ...
      <div class="widget">
        ...
        <div class="recent-post-wrap">
          <div class="recent-post">
            ...
            <div class="media-body">
              <div class="recent-post-meta">
                <a href="blog.php"><i class="fal fa-calendar-alt"></i>December 15, 2022</a>
              </div>
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit amet consectetur.</a>
              </h4>
            </div>
          </div>
          <div class="recent-post">
            ...
            <div class="media-body">
              <div class="recent-post-meta">
                <a href="blog.php"><i class="fal fa-calendar-alt"></i>March 13, 2022</a>
              </div>
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit amet consectetur.</a>
              </h4>
          ...
          <div class="recent-post">
            ...
            <div class="media-body">
              <div class="recent-post-meta">
                <a href="blog.php"><i class="fal fa-calendar-alt"></i>Augest 23, 2022</a>
              </div>
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.php">Lorem ipsum dolor sit amet consectetur.</a>
              </h4>
